...
export const FIELDS = {
    [RECURSIVE_CATEGORIES.IDENTIFIERS]: [
        ...
        { label: 'AL ID (Exclude)', path: 'id_not', type: FIELD_TYPES.NUMBER },
        { label: 'AL ID (List)', path: 'id_in', type: FIELD_TYPES.LIST },
        { label: 'AL ID (Exclude List)', path: 'id_not_in', type: FIELD_TYPES.LIST },
        { label: 'MAL ID', path: 'idMal', type: FIELD_TYPES.NUMBER },
        { label: 'MAL ID (Exclude)', path: 'idMal_not', type: FIELD_TYPES.NUMBER },
        { label: 'MAL ID (List)', path: 'idMal_in', type: FIELD_TYPES.LIST },
        { label: 'MAL ID (Exclude List)', path: 'idMal_not_in', type: FIELD_TYPES.LIST }
    ],
    [RECURSIVE_CATEGORIES.TIMELINE]: [
        { label: 'Start Year', path: 'startDate.year', type: FIELD_TYPES.NUMBER },
        { label: 'Start Date (Greater)', path: 'startDate_greater', type: FIELD_TYPES.NUMBER },
        { label: 'Start Date (Lesser)', path: 'startDate_lesser', type: FIELD_TYPES.NUMBER },
        { label: 'End Year', path: 'endDate.year', type: FIELD_TYPES.NUMBER },
        { label: 'End Date (Greater)', path: 'endDate_greater', type: FIELD_TYPES.NUMBER },
        { label: 'End Date (Lesser)', path: 'endDate_lesser', type: FIELD_TYPES.NUMBER },
    ...
    [RECURSIVE_CATEGORIES.CONTENT]: [
        ...
        { label: 'Episodes (Greater)', path: 'episodes_greater', type: FIELD_TYPES.NUMBER },
        { label: 'Episodes (Lesser)', path: 'episodes_lesser', type: FIELD_TYPES.NUMBER },
        ...
        { label: 'Genres (In)', path: 'genre_in', type: FIELD_TYPES.LIST, seenKey: 'genres' },
        { label: 'Genres (Exclude)', path: 'genre_not_in', type: FIELD_TYPES.LIST, seenKey: 'genres' },
        { label: 'Tag Name', path: 'tags.name', type: FIELD_TYPES.COLLECTION, seenKey: 'tags' },
        { label: 'Tag (In)', path: 'tag_in', type: FIELD_TYPES.LIST, seenKey: 'tags' },
        { label: 'Tag (Exclude)', path: 'tag_not_in', type: FIELD_TYPES.LIST, seenKey: 'tags' },
    ...
    [RECURSIVE_CATEGORIES.METRICS]: [
        ...
        { label: 'Average Score (Greater)', path: 'averageScore_greater', type: FIELD_TYPES.NUMBER },
        { label: 'Average Score (Lesser)', path: 'averageScore_lesser', type: FIELD_TYPES.NUMBER },
        { label: 'Mean Score', path: 'meanScore', type: FIELD_TYPES.NUMBER },
        { label: 'Popularity', path: 'popularity', type: FIELD_TYPES.NUMBER },
        { label: 'Popularity (Greater)', path: 'popularity_greater', type: FIELD_TYPES.NUMBER },
        { label: 'Popularity (Lesser)', path: 'popularity_lesser', type: FIELD_TYPES.NUMBER },
...
export function evaluateRule(item, rule) {
    ...
    const actualValue = getValueByPath(item, path);
